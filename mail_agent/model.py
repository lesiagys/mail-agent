...
MODEL_ALIASES = {
    ...
    "qwen3.6-dashscope": "qwen3.6-27b"
}

def get_model(model='qwen3.6-dashscope', temperature=0.0, top_p=None, top_k=None, callbacks: Optional[List[BaseCallbackHandler]] = None, reasoning: bool = True, provider='alibaba'):
