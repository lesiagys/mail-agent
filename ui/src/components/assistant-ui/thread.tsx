...
import {
  DECISION_MARKER,
  useInterruptApprovalUI,
} from "@/components/assistant-ui/interrupt-approval";
import {
  ToolGroupContent,
  ToolGroupRoot,
  ToolGroupTrigger,
...
const isDecisionMarkerText = (s: AssistantState) => {
  const parts = s.message.parts;
  return (
    parts.length === 1 &&
    parts[0].type === "text" &&
    parts[0].text.startsWith(DECISION_MARKER)
  );
};
